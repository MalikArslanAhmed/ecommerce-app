        ...
        <div className='wrapper-three'>
            <div className='main-container'>
                <div className='container-one'>
                    <b className='daraz-transformed-online-shopping'>How Daraz Transformed Online Shopping in Pakistan</b>
                    <p className='daraz-transformed-online-shopping-paragragh'>Daraz first made waves in Pakistan’s e-commerce market after its introduction in 2012. We have since grown to become Pakistan’s largest platform for online shopping with a network spread across Asia in Pakistan, Bangladesh, Sri Lanka, Myanmar, and Daraz.com.np. Our vision was to provide a safe, efficient online marketplace platform for vendors and customers across the country to come together. We started off exclusively as an online fashion retail platform and over the years expanded to become a complete one-stop solution for all your buying needs.  Daraz prides itself on not being just another ecommerce venture in Asia. We work tirelessly to make sure that we provide users with the best online online shopping experience and value for their purchases. Whether you shop online through our website or our online shopping mobile App, you can expect easy navigation, customized recommendations, and a smooth online shopping experience guaranteed.</p>
                    <h2 className='what-makes-us-different'>What Makes Us Different from Other Online Shopping Platforms?</h2>
                    <b className='online-marketplace'>Select from the Largest Online Marketplace in Pakistan</b>
                    <p className='listing-of-products-in-the-country'> With over 15 million products to select from, Daraz offers its customers the most comprehensive listing of products in the country. Whether you’re looking for electronics, apparel, appliances, or groceries – there is something for everyone.</p>
                    <b className='hassle-free-delivery'>Hassle Free Delivery </b>
                    <p className='daraz-promises'> Online shopping is only as good as its execution and Daraz promises hassle free delivery right from the moment you order to when your package is dropped at your door. We cater to both major and smaller cities alike, and give you the choice to track your package as it makes its way to you so you always know your order status. If you are unsatisfied with any aspect of your order, we have a simple 7-day return or exchange policy. </p>
                    <b className='payment-options-to-suit'>Payment Options to Suit Every Style </b>
                    <p className='pay-through-a-credit-debit-card'> You can choose to pay through a credit/debit card, opt for cash on delivery or even go for EMI (easy monthly instalments). You can also avail exclusive offers by downloading Daraz Wallet – a closed loop digital wallet</p>
                </div >
                <div className='container-two'>
                    <p>that offers you a secure, easy way to make payments. We also have easypaisa & jazzcash payment method for our customers' ease</p>
                    <b className='verified-vendors'>Shop from Verified Vendors</b>
                    ...
                    <p>
                        <b>Avail Exclusive Discounts, Offers, and Promotions</b><br />
                    ...
                    <b>Buy Value, not Just Goods with Daraz Care</b><br />
                    <p>Daraz does not just cater online shopping in Pakistan but also aims to simplify the way you give back to society. With charities spanning across sectors of education, health care, environmental preservation, and shelters, you can choose to make a big difference with a few, simple clicks.<br />
                    </p>
                    <b>Simplify Corporate Purchases</b><br />
